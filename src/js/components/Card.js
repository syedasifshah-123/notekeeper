...
export const Card = function (noteData) {
    ...
    $card.innerHTML = `
        <h3 class="card-title text-title-medium">${title}</h3>
            ...
            <p class="crad-text text-body-large">${text}</p>
     ...
     * 
     * Attaches a click event listeners to card element. 
     ...
     * 
     * Attaches a click event listeners to delete button element within cards. 
     * when the delete button is clicked, it opens a confirmation modal fror deleteing the associated note. 
