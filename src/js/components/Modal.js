...
/**
 * Create and manages a modal for adding or edititng notes. The modal allows users to input a note's title and text, 
 ...
 * @param {string} [time=''] - An object containing functions to open the modal, close the modal, and handle note submission. 
 */
...
const NoteModal = function (title = "Untitled", text = "Add your note...", time = "") {
    ...
    /**
     * Open the note modal by appending it to the document body and and setting focus on the title field. 
     */
    ...
    /**
     * close the modal by removing it from the dodument body. 
     */
     ...
     * 
     * @param {Function} callback - The callback function to executewith the submittedd note data. 
     */
 ...
 * @returns {Object} - An object containg functions to open the modal, close the modal, and handle confirmation.
 */
...
const DeleteConfirmModal = function (title) {
     ...
     * 
     * @param {Function} callback - The callback function to execute with the confirmation result (true for confirmation, flase for cancel). 
     */
